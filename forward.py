...
parser.add_argument("--save-path",default="output.png",help="output save location")
parser.add_argument("--input-image",default="example.png",required=True,help="input image location")
...
if __name__ == "__main__":
    result = generate(opt.input_image,opt)
